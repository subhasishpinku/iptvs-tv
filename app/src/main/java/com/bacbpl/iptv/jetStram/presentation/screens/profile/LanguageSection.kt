...
//    }
//}
// com/bacbpl/iptv/jetStram/presentation/screens/profile/LanguageSection.kt
// Update to show actual language options
...
fun LanguageSection(
    ...
    val languageItems = listOf("English", "বাংলা", "हिंदी")
    val languageCodes = listOf("en", "bn", "hi")
