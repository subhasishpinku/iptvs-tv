...
//import com.bacbpl.iptv.jetStram.presentation.common.ImmersiveListMoviesRow
//import com.bacbpl.iptv.jetStram.presentation.common.ItemDirection
//import com.bacbpl.iptv.jetStram.presentation.common.PosterImage
//import com.bacbpl.iptv.jetStram.presentation.screens.dashboard.rememberChildPadding
//import com.bacbpl.iptv.jetStram.presentation.utils.bringIntoViewIfChildrenAreFocused
//
//@Composable
//fun Top10MoviesList(
//    movieList: MovieList,
...
fun Top10MoviesList(
    ...
    // Safe initialization - check if list is not empty
    var selectedMovie by remember(movieList) {
        mutableStateOf(if (movieList.isNotEmpty()) movieList.first() else null)
    }
    ...
    if (movieList.isNotEmpty() && selectedMovie != null) {
        ...
        // Show placeholder or nothing when list is empty
