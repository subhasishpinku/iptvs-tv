...
import com.bacbpl.iptv.jetStram.presentation.utils.GradientBg
@Composable
    ...
    when (val state = uiState) {
        ...
        CategoriesScreenUiState.Error -> {
            ...
            Box(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Button(
                        onClick = { categoriesScreenViewModel.loadCategories() }
                    ) {
                        Text("Retry")
                    }
                }
        ...
        is CategoriesScreenUiState.Ready -> {
            Catalog(
                ...
                movieCategories = state.categoryList,
